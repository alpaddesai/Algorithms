...
int OptimalMSTAlgorithms()
{

	cout << " ***************** Optimal MST Algorithms *************** " << endl << endl;
	...
	time_point startTimer2 = system_clock::now();
	SimpleProjectGraph.PrimAlgorithm();
	time_point endTimer2 = system_clock::now();
	duration PrimAlgorithmTime = endTimer2 - startTimer2;
	cout << "Duration of Prim Algorithm Time for " << numPins << "  pins is " << PrimAlgorithmTime.count() << endl;
